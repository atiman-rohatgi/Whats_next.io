...
import apiClient from '../services/apiClient'; // CHANGED: Import the authenticated client
...
export default function Chatbot() {
  ...
  const handleChatSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // CHANGED: Use apiClient instead of axios for the authenticated request
      const response = await apiClient.post('/chat', { query: currentQuery });
